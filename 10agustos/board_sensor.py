...
frame = None
model = YOLO('/home/kovan-robot/ultralytics/agustos9best.pt')
names = model.names
...
class camera_XYZ:
    ...
    def find_board_coord(self, frame):
        ...
        img = cv2.adaptiveThreshold(img, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY_INV, 27, 5)
...
def capture_and_detect():
    ...
    if new_frame is not None:
        ...
        results = model(new_frame, conf=0.66)
