...
class ImageListener:
    def __init__(self, depth_image_topic, depth_info_topic,pixels):
...
def main():
    ...
    pixels = (int(sys.argv[1]),int(sys.argv[2]))
        
    print(node_name,pixels)
    ...
    print ('Application then calculates and print depth of the given point that in pixel.')
    ...
    listener = ImageListener(depth_image_topic, depth_info_topic,pixels)
    rospy.spin()
