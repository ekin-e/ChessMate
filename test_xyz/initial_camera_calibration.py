...
workingdir="home/ekin/catkin_ws/src/panda_chess/camera_calib/"
...
for fname in images:
    ...
    if ret == True:
        ...
        # Save center pixel of the board
        center = tuple(corners[3 * (7,7) + 3].ravel())
...
# Save center of the chess board    
np.save(savedir+'board_center.npy', center)
print("Board center")
print(center)
