...
# !!!!!change this path
stockfish = Stockfish(path="/home/gursel/kovan_ws/src/stockfish/stockfish-ubuntu-x86-64")
...
########## GLOBAL VARIABLES ##########
global game_state, best_move, piece_coord
...
def buttonCallback(button_msg):
    ...
    if button_msg.data:
        ...
        if chess_table_after != None: 
            chess_table_after_fen = chess_table_to_fen(chess_table_after)
...
########## GAME LOOP ##########
def game_loop(data):
    global game_state, best_move, stockfish, move_complete, is_castling_move, is_en_passant_move, piece_coord, robot_color, board
